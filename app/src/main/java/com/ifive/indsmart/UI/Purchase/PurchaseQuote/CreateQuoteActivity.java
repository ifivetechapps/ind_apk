...
import com.ifive.indsmart.UI.Purchase.PurchaseQuote.Adapter.QuoteLineAdapter;
...
public class CreateQuoteActivity extends BaseActivity implements SupplierListAdapter.onItemClickListner {
    Realm realm;
    ...
    String enquiry_Date;
    QuoteLineAdapter quoteLineAdapter;
    RealmList<QuotationLines> quoteItemLineLists = new RealmList<> ();
    RealmList<QuotationLines> quotationLinesRealmList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        type_quote = intent.getStringExtra ("");
        ...
        type_quote = "standard";
        quotationLinesRealmList.add (new QuotationLines ());
    }

    @OnClick(R.id.delivery_date)
    public void salesorderDate() {
        DatePickerDialog dialog = new DatePickerDialog (CreateQuoteActivity.this, new DatePickerDialog.OnDateSetListener () {
    ...
    private void loadItemAdapter() {
        ...
        quoteLineAdapter = new QuoteLineAdapter (this, quoteItemLineLists, products, this);
        ...
        quotationLinesRealmList = quoteItemLineLists;
        ...
        observable
                ...
                .subscribe (new Observer<Integer> () {
                    ...
                    public void onCompleted() {
                        ...
                        Intent intent = new Intent (CreateQuoteActivity.this, SubDashboard.class);

...
import com.ifiveuv.indsmart.Connectivity.Message;
import com.ifiveuv.indsmart.Connectivity.Products;
import com.ifiveuv.indsmart.Connectivity.SendApprovalId;
...
import com.ifiveuv.indsmart.UI.PurchaseRequisition.Adapter.ViewRequisitionLineAdapter;
...
public class ApproveRequisitionActivity extends BaseActivity {
    ...
    private void loadRequisitionItemAdapter() {
        ...
        results = realm.where (RequisitionHeader.class)
                .equalTo ("Hdrid", hdrid)
                .findAll ();
        headerId=results.get (0).getOnlineReqId ();
